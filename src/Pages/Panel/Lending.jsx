...
const Lending = () =>{
  ...
  <div className="dashboard-layout">
    <div
      ...
      data-dashboard--mobile-header-page="lending"
    >
      <label
        ...
        <div className="modal-content rounded-0 border-0">
          <div className="modal-body text-uppercase p-0">
            ...
            <ul className="list-unstyled dashboard-menu m-0">
              ...
              <li className="renting-index-item lending-index-item active">
                <a
                  className="text-uppercase"
                  href="/Panel/lending"
                >
    ...
    <div className="first-section">
      ...
      <ul
        ...
        data-dashboard--sidenav-page="lending"
      >
        ...
        <li className="renting-link lending-link active">
          <a
            className="text-uppercase"
            href="/Panel/lending"
          >
                ...
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    ...
                    >
                      ...
                      <input
                        autoComplete="off"
                        defaultValue="JO4x+LMatkLkn25czwcz+cF/icprYeqKmRM30ukTt68bsDArEoDVVMTe2cHfQoUnXOyThEIxPEenh1O+NPOvfQ=="
