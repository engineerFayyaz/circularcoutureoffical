                        ...
                        <div className="container">
                                ...
                                <div className="breadcrumbs">
                                    ...
                                    >
                                        ...
                                        <li
                                            ...
                                            itemType="http://schema.org/ListItem"
                                        >
                                            <span itemProp="name">Gold Coast Dress Hire</span>
                            ...
                            <div className="plp-intro__container">
                                <h1
                                    ...
                                    data-titletype="city"
                                >
                                    Gold Coast Dress Hire <span className="plp-intro__search-query" />
                                </h1>
                                    ...
                                    <div className="plp-intro__text js-readmore-container">
                                        <div className="plp-intro__text-wrapper js-readmore">
                                            <div className="js-ellipsize regular-content" data-stop=">769">
                                                <p>
                                                    Known for its beautiful beaches and glittery{" "}
                                                    <a href="occasion/night-out-dresses.html">nightlife</a>, the
                                                    Gold Coast may be one of the most versatile fashion
                                                    destinations in Australia. Boho maxi dresses are equally at
                                                    home in this Queensland holiday spot as the most
                                                    body-hugging <a href="length/mini-dresses.html">minis</a>.
                                                    Local style is eclectic and reflective of the varied
                                                    interests and personalities of its residents. One thing that
                                                    they all have in common a mastery of how to make
                                                    warm-weather dressing look chic.
                                                </p>
                                                <p>
                                                    Shopping in the Gold Coast is an outdoor affair at the
                                                    city's largest retail center, Pacific Fair, which features
                                                    internationally renowned fashion houses and Australian
                                                    favourites. Local labels that have made a name for
                                                    themselves on the international scene include Peony Swimwear
                                                    and Valley Eyewear. The more recent addition of Gold Coast
                                                    Fashion Week to the calendar each May is a boon for this
                                                    newly established style capital.
                                                </p>
                                                <p>
