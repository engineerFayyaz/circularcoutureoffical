...
const Skirts = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1004`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Explore Circular's skirts collection, where sustainability meets sophistication. From versatile midi skirts to playful minis, each piece is designed with eco-conscious materials and timeless style in mind. Elevate your wardrobe with skirts that make a statement while contributing to a more sustainable fashion future.
                </div>
              </div>
            </div>
          </div>
