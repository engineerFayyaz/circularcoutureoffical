...
const DressMidi = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1011`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Elevate your style with Circular's midi dress collection. From versatile classics to trend-setting designs, each piece combines sustainability with chic sophistication for a wardrobe staple that's both timeless and on-trend.
                </div>
              </div>
            </div>
          </div>
