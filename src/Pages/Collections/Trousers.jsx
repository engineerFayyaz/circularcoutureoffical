...
const Trousers = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1005`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Discover comfort and style in Circular's trousers collection. From tailored classics to casual essentials, each pair is crafted with sustainable materials for a wardrobe that's as conscious as it is chice.
                </div>
              </div>
            </div>
          </div>
