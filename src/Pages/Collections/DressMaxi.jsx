...
const DressMaxi = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1012`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Experience effortless glamour with Circular's maxi dress collection. From flowing silhouettes to bold prints, each piece offers sustainable elegance for those special occasions or everyday chic.
                </div>
              </div>
            </div>
          </div>
