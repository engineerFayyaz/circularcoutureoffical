...
const Tops = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1003`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Elevate your look with Circular's tops collection. From essential basics to statement pieces, find sustainable style for every occasion.
                </div>
              </div>
            </div>
          </div>
