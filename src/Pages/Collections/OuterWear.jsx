...
const OuterWear = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1007`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                Elevate your outerwear with Circular's collection. From sleek jackets to cozy coats, each piece blends style with sustainability for a wardrobe that's as chic as it is conscious.
                </div>
              </div>
            </div>
          </div>
