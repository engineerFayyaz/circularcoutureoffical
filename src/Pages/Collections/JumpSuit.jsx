...
const JumpSuit = () => {
  ...
  useEffect(() => {
      const fetchProducts = async () => {
          try {
              const response = await fetch(`https://circularclientapi.azurewebsites.net/api/products/catogery-Gen/1008`, {
                  method: 'GET',
                  headers: {
          ...
          <div className="container pl-5 pb-5 mt-0">
            <div>
              ...
              >
                ...
                "Make a statement with Circular's jumpsuit collection. From sleek and sophisticated to relaxed and casual, each piece combines comfort with sustainable style for effortless elegance in one piece."
                </div>
              </div>
            </div>
          </div>
