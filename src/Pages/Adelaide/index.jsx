                        ...
                        <div className="container">
                                ...
                                <div className="breadcrumbs">
                                    ...
                                    >
                                        ...
                                        <li
                                            ...
                                            itemType="http://schema.org/ListItem"
                                        >
                                            <span itemProp="name">Adelaide Dress Hire</span>
                            ...
                            <div className="plp-intro__container">
                                <h1
                                    ...
                                    data-titletype="city"
                                >
                                    Adelaide Dress Hire <span className="plp-intro__search-query" />
                                </h1>
                                    ...
                                    <div className="plp-intro__text js-readmore-container">
                                        <div className="plp-intro__text-wrapper js-readmore">
                                            <div className="js-ellipsize regular-content" data-stop=">769">
                                                <p>
                                                    Adelaide may be the city of churches, but fashionable locals
                                                    are replacing the city's staid, conservative reputation with
                                                    a playful, anything-goes attitude toward their wardrobe.
                                                    Adelaide city and surrounds offer residents a beach-focused,
                                                    outdoor lifestyle unencumbered by the pressures that usually
                                                    plague a capital city. Being one of the more laid-back
                                                    cities, this casual attitude is translated into the way the
                                                    residents dress- mixing modern street style with the classic
                                                    pieces.
                                                </p>
                                                <p>
                                                    All you have to do is visit Rundle Mall for a shop or
                                                    explore the storied food markets to see that the South
                                                    Australian capital has an identity all its own. Adelaide is
                                                    home to successful Australian label '
                                                    <a href="designer/finders-keepers.html">Finders</a>',
                                                    founded in 2007, as well as designer and Young Australian of
                                                    the Year (2017), Paul Vasileff (Paolo Sebastian).
                                                </p>
                                                <p>
                                                    The Adelaide Fashion Festival is held each October as a
                                                    premier fashion event on the Australian calendar.
                                                </p>
                                                <p>
