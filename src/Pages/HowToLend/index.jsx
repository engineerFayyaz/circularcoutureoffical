      ...
      <div className="row">
        <div className="col">
          <div className="collection-item">
            <img
              alt=""
              src="images/icons/user-account (1).png"
              width="60"
            />
        ...
        <div className="col">
          <div className="collection-item">
            <img
              alt=""
              src="images/icons/mobile-data.png"
              width="60"
            />
            <div className="collection-title text-center mt-5">
              <h4>
  ...
  <section>
    <div className=" component-container-2 mt-5">
      <div
        ...
        style={{
          backgroundImage: 'url(images/background-images/the\ perks.jpg) !important',
        ...
        <div className="col d-flex align-items-center justify-content-start justify-content-md-start">
          <div className="single-banner-content text-start px-5">
            ...
            >
              ...
              <li className="mb-3 ">
                Become a top lender with rewards
              </li>
              <li className="mb-3 ">
