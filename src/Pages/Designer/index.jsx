  ...
  return (
    <>
      ...
      <div className="main-container pt-0 -with-cta-banner">
        ...
        >
          <div
            className="header-bar text-center header-fixed"
          ...
          >
            ...
            <div className="description">
              <div className="trix-content">
                {' '}From RIXO to Ganni, here are the designers available to rent on CIRCULAR COUTURE. Looking for our official brand partners? Click below.{' '}
              </div>
            </div>
            {' '}
            <Link
          ...
          <div className="letter-bar">
            ...
            <div className="swipe text-center">
              {' '}
              <img
                alt="An icon of a double arrow left"
                className="mb-1 mr-2"
                src="https://res.cloudinary.com/dcaptnlz3/image/asset/double-arrow-left-6ecc2d4c2b9cecb7f8f7ad4320954fcc"
              />
              {' '}
              <span className="text-uppercase">
                Swipe Across To See More Letters
              </span>
              {' '}
              <img
                alt="An icon of a double arrow right"
                className="mb-1 ml-2"
                src="https://res.cloudinary.com/dcaptnlz3/image/asset/double-arrow-right-1d145b997413fab713b1acbfe295d8f9"
              />
              {' '}
            </div>
          </div>
          <div className="container">
            <div className="px-3">
              <div className="pb-3">
                <div className="designers-section text-uppercase">
                  <h3
                    className="brand-column__header second-title"
                    data-designers-letter-bar-target="scrollDestination"
                    data-scroll-destination="A"
                  >
                    A
                  </h3>
                ...
                <div className="designers-section text-uppercase">
                  <h3
                    className="brand-column__header second-title"
                    data-designers-letter-bar-target="scrollDestination"
                    data-scroll-destination="number"
                  >
                    #
                  </h3>
                  <div className="row no-gutters">
