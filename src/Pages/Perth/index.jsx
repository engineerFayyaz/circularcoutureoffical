                        ...
                        <div className="container">
                                ...
                                <div className="breadcrumbs">
                                    ...
                                    >
                                        ...
                                        <li
                                            ...
                                            itemType="http://schema.org/ListItem"
                                        >
                                            <span itemProp="name">Perth Dress Hire</span>
                            ...
                            <div className="plp-intro__container">
                                <h1
                                    ...
                                    data-titletype="city"
                                >
                                    Perth Dress Hire <span className="plp-intro__search-query" />
                                </h1>
                                    ...
                                    <div className="plp-intro__text js-readmore-container">
                                        <div className="plp-intro__text-wrapper js-readmore">
                                            <div className="js-ellipsize regular-content" data-stop=">769">
                                                <p>
                                                    Perth style reflects its sunny weather, amazing beaches and
                                                    isolated position on the western edge of Australia. Locals
                                                    opt for relaxed-chic attire and like to march to the beat of
                                                    their own drum. Whether it be a coffee catch-up on Beaufort
                                                    Street or sunset drinks at the Cottesloe Hotel, in Perth
                                                    you'll find the people sporting a uniquely refined
                                                    west-coast-casual vibe.
                                                </p>
                                                <p>
                                                    This hasn't stopped the WA capital from making its own mark
                                                    on the Australian and global fashion landscape. Perth has
                                                    produced several style powerhouses like designer Kym Ellery
                                                    (whose dresses grace the runways of Paris Fashion Week) as
                                                    well as supermodel Gemma Ward. In an effort to promote the
                                                    upcoming local fashion talent on an international stage, the
                                                    Telstra Perth Fashion Festival is held in September each
                                                    year.
                                                </p>
                                                <p>
