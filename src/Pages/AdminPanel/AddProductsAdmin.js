                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3 mt-3">
                    ...
                    <Form.Control
                      ...
                      onChange={handleInputChange}
                      onClick={() => handleEditableClick("sellPrice", formData.sellPrice)}
                    />
                  </Form.Group>
                  <Form.Group className="mb-3 mt-3">
                    ...
                    <Form.Control
                      ...
                      onChange={handleInputChange}
                      onClick={() => handleEditableClick("rentPrice4Days", formData.rentPrice4Days)}
                    />
                  </Form.Group>
                  <Form.Group className="mb-3 mt-3">
                    ...
                    <Form.Control
                      ...
                      onChange={handleInputChange}
                      onClick={() => handleEditableClick("rentPrice8Days", formData.rentPrice8Days)}
                    />
                  </Form.Group>
                  <Form.Group className="mb-3 mt-3">
                    ...
                    <Form.Control
                      ...
                      onChange={handleInputChange}
                      onClick={() => handleEditableClick("rentPrice16Days", formData.rentPrice16Days)}
                    />
                  </Form.Group>
                  <Form.Group className="mb-3 mt-3">
                    ...
                    <Form.Control
                      ...
                      onChange={handleInputChange}
                      onClick={() => handleEditableClick("rentPrice30Days", formData.rentPrice30Days)}
                    />
                  </Form.Group>
