                        ...
                        <div className="container">
                            ...
                            <div className="plp-intro__container">
                                <h1
                                    ...
                                    data-titletype="ProductType"
                                >
                                    Kids <span className="plp-intro__search-query" />
                                </h1>
                                    ...
                                    <div className="plp-intro__text js-readmore-container">
                                        <div className="plp-intro__text-wrapper js-readmore">
                                            <div className="js-ellipsize regular-content" data-stop=">769">
                                                ATD has finally started offering kids designer clothing for
                                                hire! Whether it's for a photo shoot, a christening or family
                                                wedding, your little loves can wear luxury labels at a
                                                fraction of the cost. Why buy when they'll grow out of it in 6
                                                months anyway? Find items for boys, girls and babies from
                                                labels such as{" "}
                                                <a
                                                    title="Dolce & Gabbana Kids Clothes for Hire"
                                                    href="../designer/dolce-and-gabbana/kids-clothing-hire.html"
                                                >
                                                    Dolce &amp; Gabbana
                                                </a>
                                                ,{" "}
                                                <a
                                                    title="Burberry Kids Clothes for Hire"
                                                    href="../designer/burberry/kids-clothing-hire.html"
                                                >
                                                    Burberry
                                                </a>
                                                ,{" "}
                                                <a
                                                    title="Fendi Kids Clothes for Hire"
                                                    href="../designer/fendi/kids-clothing-hire.html"
                                                >
                                                    Fendi
                                                </a>
                                                ,{" "}
                                                <a
                                                    title="Balmain Kids Clothes for Hire"
                                                    href="../designer/balmain/kids-clothing-hire.html"
                                                >
                                                    Balmain
                                                </a>{" "}
                                                and{" "}
                                                <a
                                                    title="Versace Kids Clothes for Hire"
                                                    href="../designer/versace/kids-clothing-hire.html"
                                                >
                                                    Versace
                                                </a>
                                                .
