            ...
            <div className="container footer__wrapper footer__top-searches">
              ...
              >
                <div className="col-6 col-md-2 footer__menu text-sm-start">
                  ...
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Alemais</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Zimmermann</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Black Tie Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">L'idée</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">School Formal Dresses</Link>
                    </li>
                  </ul>
                </div>
                <div className="col-6 col-md-2 footer__menu no-title">
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Elliatt</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Long Sleeve Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Winona</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Aje</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Maxi Dresses</Link>
                    </li>
                  </ul>
                </div>
                <div className="col-6 col-md-2 footer__menu no-title">
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Midi Dresses</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/Designers/Alemais">Leo Lin</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Sir The Label</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Chanel</Link>
                    </li>
                  </ul>
                </div>
                <div className="col-6 col-md-2 footer__menu no-title">
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Bec & Bridge</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Rat & Boa</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Sequin Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Saint Laurent</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">White Dresses</Link>
                    </li>
                  </ul>
                </div>
                <div className="col-6 col-md-2 footer__menu no-title">
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Lia Stublla</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Black Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Formal Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Engagement Party</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Shona Joy</Link>
                    </li>
                  </ul>
                </div>
                <div className="col-6 col-md-2 footer__menu no-title">
                  <ul className="footer__menu-list">
                    <li>
                      <Link to="/Designers/Alemais">Sonya</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Party Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Bags & Clutches</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Hen's Party Dresses</Link>
                    </li>
                    <li>
                      <Link to="/Designers/Alemais">Floral Dresses</Link>
                    </li>
                  </ul>
                </div>
              </div>
